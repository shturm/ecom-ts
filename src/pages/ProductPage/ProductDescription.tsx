  ...
  return (
    <React.Fragment>
      ...
      {/* <ProductDescriptionDetail
        label=""
        value={props.product.ProductFeatures}
      /> */}
      {/* <ProductDescriptionDetail
        label=""
        value={props.product.ProductCharacteristics}
      /> */}
      ...
      <ProductDescriptionDetail
        label="XML Barcodes"
        value={props.product.ProductVariants.map((x) => x.Barcode)}
      />
      ...
      {/* <ProductDescriptionDetail
        label="Снимки Shopify"
        value={props.product.ImageUrlsShopify}
      /> */}
      {/* <ProductDescriptionDetail label="Снимки (локални файлове)" value={props.product.ImageFilenames} /> */}
      {/* <ProductDescriptionDetail
        label="Допълнително описание"
        value={props.product.DescriptionAdditional}
      /> */}
      {/* <ProductDescriptionDetail
        label="Свойства - описание"
        value={props.product.PropertiesDescription}
      /> */}
      <ProductDescriptionDetail label="Защитни Свойства" value={props.product.Properties} />
      <ProductDescriptionDetail
        label="Защитни свойства - детайлно"
        value={props.product.ProtectiveProperties.map((x) => { return `${x.Description}-${x.Value}`} )}
      />
      <ProductDescriptionDetail
        label=""
        value={props.product.PropertiesAdditional}
      />
      <ProductDescriptionDetail label="" value={props.product.Industries} />
      <ProductDescriptionDetail label="" value={props.product.ShoeKind} />
      <ProductDescriptionDetail label="" value={props.product.ShoeType} />
      <ProductDescriptionDetail label="" value={props.product.Model} />
      <ProductDescriptionDetail label="" value={props.product.LiningMaterial} />
      <ProductDescriptionDetail label="" value={props.product.AssemblyMethod} />
      <ProductDescriptionDetail label="" value={props.product.Toe} />
      <ProductDescriptionDetail
        label=""
        value={props.product.ProtectionCategory}
      />
      <ProductDescriptionDetail
        label=""
        value={props.product.ProtectionStandard}
      />
      <ProductDescriptionDetail label="" value={props.product.Pattern} />
      <ProductDescriptionDetail label="" value={props.product.Category} />
      <ProductDescriptionDetail label="" value={props.product.Gender} />
      <ProductDescriptionDetail
        label=""
        value={props.product.ShoeConstruction}
      />
      <ProductDescriptionDetail label="" value={props.product.Sizes} />
      ...
      <ProductDescriptionDetail
        label=""
        value={props.product.HasUniformPriceAcrossVariants}
      />
